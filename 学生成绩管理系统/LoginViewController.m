...
- (void)viewDidLoad {
    ...
    NSLog(@"%ldfdg",_accountMutableArray.count);
...
- (void)LoginClick
{
    ...
    [_accountMutableArray addObject:loginAccount];
...
- (void)RegisterClick
{
    ...
    _addNewAccount = [[AccountMessage alloc] initWithAccount:_accountTextField.text andPassword:_passwordTextField.text];
